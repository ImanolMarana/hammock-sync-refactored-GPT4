...
public interface Query {
     ...
     * {@link FieldSort.Direction#ASCENDING} direction. If there are one or more members of {@code
     * fields} with a direction of {@link FieldSort.Direction#DESCENDING}, an exception will be thrown.
     * </p>
     * <p>
     * To return data in descending order, create an index with {@link FieldSort.Direction#ASCENDING} fields
     * and execute the subsequent query with {@link FieldSort.Direction#DESCENDING} fields as required.
     * </p>
     * <p>
     ...
     * {@link DocumentStore} which have changed since the last
     * update.
     * </p>
     *
