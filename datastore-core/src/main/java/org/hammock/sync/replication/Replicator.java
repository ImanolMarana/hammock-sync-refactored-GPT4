 ...
 * {@link DocumentStore} and a remote Cloudant or
 * CouchDB database.</p>
 *
...
public interface Replicator {
     ...
     * {@link Replicator#getState()} if they need
    ...
    enum State {
         ...
         * {@link Replicator#stop()}.
         */
        STOPPED,
        /**
         * {@link Replicator#stop()} has
     ...
     *
     * <ul>
     *     <li>{@link ReplicationErrored} if
     *     there is an error during replication.</li>
     *     <li>{@link ReplicationCompleted}
