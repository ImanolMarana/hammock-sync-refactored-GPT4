...
import org.hammock.sync.internal.mazha.CouchException;
import org.hammock.sync.internal.mazha.DocumentConflictException;
import org.hammock.sync.internal.mazha.DocumentRevs;
import org.hammock.sync.internal.mazha.NoResourceException;
import org.hammock.sync.internal.mazha.OkOpenRevision;
import org.hammock.sync.internal.mazha.OpenRevision;
...
public class CouchClientWrapper implements CouchDB {
    ...
    public Iterable<DocumentRevsList> bulkGetRevisions(List<BulkGetRequest> requests,
        ...
        List<org.hammock.sync.internal.mazha.BulkGetRequest> splitRequests = new ArrayList<org.hammock.sync.internal.mazha.BulkGetRequest>();

        // split the requests out
        for (BulkGetRequest request : requests) {
            for (String rev : request.revs) {
                org.hammock.sync.internal.mazha.BulkGetRequest splitRequest = new org.hammock.sync.internal.mazha.BulkGetRequest();
