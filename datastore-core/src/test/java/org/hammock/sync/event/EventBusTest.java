...
package org.hammock.sync.event;

import static org.junit.Assert.assertEquals;
import static org.junit.Assert.assertNotEquals;
import static org.junit.Assert.assertTrue;

import org.hammock.sync.event.notifications.Notification;
...
public class EventBusTest {
    ...
    public  void privateSubscriber() throws Exception {
        ...
        thrown.expectMessage("Event Subscriber class org.hammock.sync.event.EventBusTest$PrivateSubscriber needs to be public");
    ...
    public void protectedSubcriber() throws Exception {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Event Subscriber class org.hammock.sync.event.EventBusTest$ProtectedSubScriber needs to be public");
        bus.register(new ProtectedSubScriber());
    }

    /**
     * Test that an anonymous inner class is rejected, this is because Anonymous inner classes cannot be public.
     * @throws Exception
     */
    @Test
    public void anonymousClass() throws Exception {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Event Subscriber class org.hammock.sync.event.EventBusTest$2 needs to be public");
    ...
    public void packageProtectedSubScriber() throws Exception {
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Event Subscriber class org.hammock.sync.event.EventBusTest$PackageProtectedSubscriber needs to be public");
    ...
    public void packageProtectedSubMethod(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method org.hammock.sync.event.EventBusTest$PackageProtectedMethodSubscriber#doNothing is required to be public");
    ...
    public void protectedSubMehtod(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method org.hammock.sync.event.EventBusTest$ProtectedMethodSub#doNothing is required to be public");
    ...
    public void privateSubMethod(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method org.hammock.sync.event.EventBusTest$PrivateMethodSub#doNothing is required to be public");
    ...
    public void subMethodWith2Parameters(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method  org.hammock.sync.event.EventBusTest$SubscriberMethod2Params#doNothing2Arg is required to have only 1 parameter");
    ...
    public void subMethodWith0Parameters(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method  org.hammock.sync.event.EventBusTest$SubscriberMethod0Params#doNothing0Arg is required to have only 1 parameter");
    ...
    public void subMethodWithObjectTypeParameter(){
        thrown.expect(IllegalArgumentException.class);
        thrown.expectMessage("Subscriber method org.hammock.sync.event.EventBusTest$UnassignableToNotificationSubscriber#doNothing parameter is required to be assignable org.hammock.sync.event.notifications.Notification");
