...
public class QueryTest extends AbstractIndexTestBase {
    ...
    public void deleteFailOnNoIndexName() throws QueryException {
        ...
        assertThat(im.listIndexes(), Matchers.contains(IndexMatcherHelpers.getIndexNameMatcher("basic")));
    ...
    public void createIndexWithSpaceInName() throws QueryException {
        ...
        assertThat(im.listIndexes(), Matchers.contains(IndexMatcherHelpers.getIndexNameMatcher("basic index")));
    }
    ...
    public void createIndexWithKeyWordName() throws QueryException {
        ...
        assertThat(im.listIndexes(), Matchers.contains(IndexMatcherHelpers.getIndexNameMatcher("INSERT INDEX")));
    }
    ...
    public void deleteTheCorrectEmptyIndex() throws QueryException {
        ...
        assertThat(im.listIndexes(), Matchers.containsInAnyOrder(IndexMatcherHelpers.getIndexNameMatcher("basic"), IndexMatcherHelpers.getIndexNameMatcher("basic2"), IndexMatcherHelpers.getIndexNameMatcher("basic3")));

        im.deleteIndex("basic2");
        assertThat(im.listIndexes().size(), is(2));
        assertThat(im.listIndexes(), Matchers.containsInAnyOrder(IndexMatcherHelpers.getIndexNameMatcher("basic"), IndexMatcherHelpers.getIndexNameMatcher("basic3")));
    }
