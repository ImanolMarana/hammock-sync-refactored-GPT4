...
public class IndexUpdaterTest extends AbstractIndexTestBase {
    ...
    private void createIndex(String indexName, List<FieldSort> fieldNames, IndexType indexType) throws QueryException{
        ...
        assertThat(indexes, Matchers.hasItem(IndexMatcherHelpers.getIndexNameMatcher(indexName)));
        Index index = IndexMatcherHelpers.getIndexNamed(indexName, indexes);
        ...
        assertThat(index, IndexMatcherHelpers.hasFieldsInAnyOrder(fieldNamesPlus.toArray(new String[]{})));
