...
Hammock Sync inherits Cloudant Query - Android implementation of [Cloudant Query][1] for Android mobile devices. It is included as part of the sync-core jar file.
...
syntax. Several features of Cloudant Query are not supported in this implementation.
