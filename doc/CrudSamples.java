...
public class CrudSamples {
    ...
    public void crudSamples() throws Exception {
        ...
        json.put("type", "org.hammock.sync.example.task");
        ...
        // For more, see https://github.com/hammock-sync/hammock-sync/blob/master/doc/query.md.
        ...
        // https://github.com/hammock-sync/hammock-sync/blob/master/doc/conflicts.md
        ...
        updatedJson.put("type", "org.hammock.sync.example.task");
