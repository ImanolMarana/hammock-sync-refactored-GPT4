...
public class TestUtilsEncrypt {
    ...
    public static DocumentBody createBDBody(String filePath) throws IOException {
        byte[] data = FileUtils.readFileToByteArray(TestUtilsEncrypt.loadFixture(filePath));
    ...
    public static File loadFixture(String fileName){
        if(Misc.isRunningOnAndroid()){
            try {
                ...
                ClassLoader classLoader = TestUtilsEncrypt.class.getClassLoader();
